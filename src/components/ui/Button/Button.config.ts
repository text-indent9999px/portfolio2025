...
export const BASE_CLASSES =
  'inline-flex items-center justify-center gap-1 relative box-border border-2 font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 will-change-transform';
